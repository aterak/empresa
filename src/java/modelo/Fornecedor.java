...
@NamedQueries({
    ...
    @NamedQuery(name = "Fornecedor.findByCel", query = "SELECT f FROM Fornecedor f WHERE f.cel = :cel"),
    @NamedQuery(name = "Fornecedor.findByCep", query = "SELECT f FROM Fornecedor f WHERE f.cep = :cep"),
    @NamedQuery(name = "Fornecedor.findByCgc", query = "SELECT f FROM Fornecedor f WHERE f.cgc = :cgc"),
    ...
    @NamedQuery(name = "Fornecedor.findByProduto", query = "SELECT f FROM Fornecedor f WHERE f.produto = :produto"),
